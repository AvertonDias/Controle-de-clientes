          ...
          <aside className="hidden md:flex flex-col w-64 bg-slate-900 text-white flex-shrink-0 border-r border-slate-800">
            ...
            <div className="p-4 border-t border-slate-800 text-xs text-slate-500">
              ...
              <div className="flex gap-2">
                <Link to="/privacy" className="hover:text-white">Política</Link>
            ...
            {mobileMenuOpen && (
              ...
              >
                ...
                >
                  ...
                  <div className="mt-auto border-t border-slate-800 pt-4 flex gap-4 text-xs text-slate-400">
                    <Link to="/privacy" onClick={() => setMobileMenuOpen(false)}>Política de Privacidade</Link>
                    <Link to="/terms" onClick={() => setMobileMenuOpen(false)}>Termos de Serviço</Link>
                  </div>
                </div>
              </div>
            )}
